                ...
                <ul>
                    ...
                    @foreach ($categories as $category)
                        <li class="hover:font-semibold ml-2">
                            <a href="{{ route('productsfiltercategory', $category->category_name) }}" class="flex lg:space-x-2 py-1">
                                <span class="md:flex items-center hidden">►{{ $category->category_name }}</span>
                            </a>
                        </li>
                    @endforeach
                    {{-- FILTRO MARCAS --}}
                    ...
                    @foreach ($brands as $brand)
                        <li class="hover:font-semibold ml-2">
                            <a href="{{ route('productsfilterbrand', $brand->brand_name) }}" class="flex lg:space-x-2 py-1">
